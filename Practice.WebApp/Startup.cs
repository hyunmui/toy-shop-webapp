...
namespace Practice.WebApp
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<OrderingContext>(options => options.UseMySQL(Configuration.GetConnectionString("Default")));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, OrderingContext orderingContext)
        {
            ...
            {
                // orderingContext.Database.EnsureDeleted();
